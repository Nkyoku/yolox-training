...
PRETRAINED_NETWORK="$SCRIPT_DIR/yolox_nano.pth"
...
docker run -it --rm \
    ...
    --shm-size="$SHARED_MEMORY" $CONTAINER_TAG python3 -m yolox.tools.train -f YOLOX/exps/default/yolox_nano.py -d 1 -b 8 --fp16 -c "/root/yolox.pth"
